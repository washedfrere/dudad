            ...
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="page_title"  value="{$current_page.title|default:''}" class="form-control" placeholder="Page Title" required />
                    </div>
                    ...
                    <div class="input-group form-group col-md-12" >
                        ...
                        <input type="text" name="page_url"  value="{$current_page.url|default:''}" class="form-control no-radius" placeholder="page-url" required="required">
