<?php /* Smarty version Smarty-3.1.16, created on 2015-03-20 10:51:22
         compiled from "/homepages/7/d276964803/htdocs/dudad/testcodoforum/codoforum/sites/default/themes/default/templates/user/profile/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1316141737550bfbaa73c385-28189435%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af9bbec5aac5608314425dff2b1ffe6d64891739' => 
    array (
      0 => '/homepages/7/d276964803/htdocs/dudad/testcodoforum/codoforum/sites/default/themes/default/templates/user/profile/view.tpl',
      1 => 1426334122,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1316141737550bfbaa73c385-28189435',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_550bfbaaa40146_03837332',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550bfbaaa40146_03837332')) {function content_550bfbaaa40146_03837332($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_get_opt')) include '/homepages/7/d276964803/htdocs/dudad/testcodoforum/codoforum/sys/CODOF/Smarty/plugins/modifier.get_opt.php';
...
if (!is_callable('smarty_modifier_get_pretty_time')) include '/homepages/7/d276964803/htdocs/dudad/testcodoforum/codoforum/sys/CODOF/Smarty/plugins/modifier.get_pretty_time.php';
...
"><?php echo _t("Login");?>
    ...
    <div class="container" style="padding-top: 60px">
        ...
        <div class="row">
            <?php echo smarty_modifier_load_block("block_view_user_info_before");?>

            <div class="col-md-6 codo_profile_info" style='float: left'>
                <?php echo smarty_modifier_load_block("block_view_user_info_start");?>
                    ...
                    <div class="codo_user_name">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['can_edit']->value) {?>
                            <div id="codo_edit_profile" class="codo_edit_profile">
                                <img draggable="false" src="<?php echo @constant('DEF_THEME_PATH');?>
img/edit_white.png" />
                            </div>
                        <?php }?>
                    </div>
...
" />
                        ...
                        <div class="codo_user_details">
                            <div>
                                <span><?php echo _t("Joined");?>
: </span><?php echo smarty_modifier_get_pretty_time($_smarty_tpl->tpl_vars['user']->value->created);?>

                            </div>
                            <div>
                                <span><?php echo _t("Last login");?>
: </span><?php if ($_smarty_tpl->tpl_vars['user']->value->last_access==0) {?><?php echo _t('never');?>
...
<?php }?>
                ...
                <?php echo smarty_modifier_load_block("block_view_user_info_end");?>


            </div>
            <?php echo smarty_modifier_load_block("block_view_user_info_after");?>


            <?php echo smarty_modifier_load_block("block_user_recent_posts_before");?>


            <div class="col-md-6 codo_recent_posts" style='float: right'>

                <?php echo smarty_modifier_load_block("block_user_recent_posts_start");?>


                <div class=''>

                    <div class="codo_profile_header">
                        <div><?php echo _t('Recent posts');?>
</div>                        
                    </div>
                ...
                <?php echo smarty_modifier_load_block("block_user_recent_posts_after");?>
            
            </div>
            <?php echo smarty_modifier_load_block("block_profile_view_after");?>
