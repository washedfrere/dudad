...
// Root directory
$root_dir = "./pgrfilemanager/userfiles/imagenes/galeria";
...
<html>
<head>
<title>dudad.es:EasyGallery</title>
...
</style>Pongo mi propio estilo--><link rel="stylesheet" type="text/css" href="global.css" />
<script type="text/javascript" src="slimbox/js/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="slimbox/js/slimbox2.js"></script>
<link rel="stylesheet" href="slimbox/css/slimbox2.css" type="text/css" media="screen" />
</head>
<body>
<!--Para dudad.es--><h1>Galer&iacute;a de im&aacute;genes</h1><h3>Selecciona una galer&iacute;a en el desplegable de abajo y disfruta</h3>Si alguna imagen excede el tama&ntilde;o de tu pantalla y no puedes cerrarla, no te preocupes: pulsa la tecla ESC y se cerrar&aacute;<!--Fin inclusion de dudad.es-->
<?php
// --begin preprocessing
...
for ($y=0;$y<count($files);$y++)
{
  ...
  if (file_exists($tn_src))
  {
    ...
    if($slideshow!=1){
	  echo "<a href=\"".$ordner."/".$files[$count]."\" rel=\"lightbox-\"".$ordner. ' title="' . str_replace(".jpg", "", $files[$count])  . '">';
	}
	else{
...
echo "</div>\n";//para dudad.esinclude "../bin/menu.php"; echo $cuerpo;//fin inclusion dudad.es
?>
