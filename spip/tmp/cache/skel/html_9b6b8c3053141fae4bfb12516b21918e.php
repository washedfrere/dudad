 ...
 * Date :      Mon, 29 Dec 2008 23:33:24 GMT
 * Compile :   Thu, 14 May 2009 18:14:54 GMT (0.016s)
 * Boucles :   _documents_portfolio, _afficher_document, _documents_decompte, _documents_joints
 */ 
//
// <BOUCLE documents>
//
function BOUCLE_documents_portfoliohtml_9b6b8c3053141fae4bfb12516b21918e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_afficher_documenthtml_9b6b8c3053141fae4bfb12516b21918e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_documents_decomptehtml_9b6b8c3053141fae4bfb12516b21918e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_documents_jointshtml_9b6b8c3053141fae4bfb12516b21918e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
//
function html_9b6b8c3053141fae4bfb12516b21918e($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
'
' .
(($t1 = BOUCLE_documents_portfoliohtml_9b6b8c3053141fae4bfb12516b21918e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
...
'
	...
	' .
BOUCLE_afficher_documenthtml_9b6b8c3053141fae4bfb12516b21918e($Cache, $Pile, $doublons, $Numrows, $SP) .
'


' .
BOUCLE_documents_decomptehtml_9b6b8c3053141fae4bfb12516b21918e($Cache, $Pile, $doublons, $Numrows, $SP) .
'



	' .
(($t1 = BOUCLE_documents_jointshtml_9b6b8c3053141fae4bfb12516b21918e($Cache, $Pile, $doublons, $Numrows, $SP))!=='' ?
		((	'
	<h2>' .
...
');
	...
	return analyse_resultat_skel('html_9b6b8c3053141fae4bfb12516b21918e', $Cache, $page, 'plugins/auto/ahuntsic/inc/inc-art-documents.html');
}
