 ...
 * Date :      Sun, 07 Dec 2008 17:35:36 GMT
 * Compile :   Thu, 14 May 2009 17:37:20 GMT (7.6ms)
 * Boucles :   _afficher_contenu
 */ 
//
// <BOUCLE articles>
//
function BOUCLE_afficher_contenuhtml_e6f9ab0ac7c0be50aeb325c30a62145a(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	$where = 
			array(
			array('=', 'articles.id_article', sql_quote(interdire_scripts(entites_html((@$Pile[0]['id']),true)))), (!$Pile[0]['statut'] ? '' : ((is_array($Pile[0]['statut'])) ? sql_in('articles.statut',sql_quote($in1)) : 
...
(($t1 = strval(interdire_scripts((strlen((strlen($a = $Pile[$SP]['nom_site']) ? $a : calculer_url($Pile[$SP]['url_site'],'','url', $connect))) ? '':'vide'))))!=='' ?
		(' ' . $t1) :
		'') .
'">
<div class=\'label\'>' .
...
//
function html_e6f9ab0ac7c0be50aeb325c30a62145a($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	...
	$connect = '';
	$page = BOUCLE_afficher_contenuhtml_e6f9ab0ac7c0be50aeb325c30a62145a($Cache, $Pile, $doublons, $Numrows, $SP);

	return analyse_resultat_skel('html_e6f9ab0ac7c0be50aeb325c30a62145a', $Cache, $page, '../prive/contenu/article.html');
}
